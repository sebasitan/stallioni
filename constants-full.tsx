...
export const SERVICE_DETAILS: ServiceDetail[] = [
    ...
    // ============================================
    {
        ...
        relatedServices: ['ui-ux-design', 'website-development', 'frontend-development', 'responsive-mobile-first-development', 'landing-page-design', 'design-systems', 'wix-development'],
    ...
    // ============================================
    {
        ...
        icon: <FullStackIcon />,
        category: PortfolioCategory.WEB,
        relatedServices: ['business-web-applications', 'saas-development', 'api-development', 'third-party-integrations', 'microservices-architecture', 'web-portals', 'laravel-development'],
    ...
    // ============================================
    {
        ...
        icon: <PHPIcon />,
        category: PortfolioCategory.WEB,
        relatedServices: ['laravel-development', 'symfony-development', 'codeigniter-development', 'core-php-development', 'php-api-development', 'legacy-php-migration', 'drupal-development'],
    ...
    // ============================================
    {
        ...
        icon: <NoCodeIcon />,
        category: PortfolioCategory.SUPPORT,
        relatedServices: ['manual-testing', 'automated-testing', 'api-testing', 'performance-testing', 'cross-browser-testing', 'security-audits'],
...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
    ...
    { id: 4, title: 'Corporate Intranet & CMS', category: PortfolioCategory.WEB, industry: Industry.SAAS, technologies: ['WordPress', 'PHP', 'React', 'Docker'], description: 'A custom-built corporate intranet for a German engineering firm, enhancing internal communication for 5,000+ employees.', imageUrl: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?q=80&w=600&h=400&auto=format&fit=crop', clientLocation: 'Berlin, Germany', testimonial: 'The new intranet has boosted our employee engagement and streamlined our internal processes.' },
