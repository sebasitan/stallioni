// Heavy data: PORTFOLIO_ITEMS + BLOG_POSTS
// Separated from constants.tsx to keep the entry bundle small.
// Only import from this file in route-specific code (BlogPage, PortfolioPage,
// admin managers) or via dynamic import (seo.ts).
